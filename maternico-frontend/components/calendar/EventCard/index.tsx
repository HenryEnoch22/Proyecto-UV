...
import { ShieldCheckIcon, ShoppingCartIcon, AcademicCapIcon, PlusCircleIcon, CakeIcon} from "react-native-heroicons/outline"
...
export const EventCard = ({text, days, type}: EventCardProps) => {
